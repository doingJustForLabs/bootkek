...
from app.db_requests import update_tg_id, get_user_id_by_email  # функция записи tg_id в БД
...
async def start(message: Message):
    await message.answer("Привет, я Granite-Bot, официальный Телеграм-Бот сервиса по поиску напарников в учебе Granite!")
